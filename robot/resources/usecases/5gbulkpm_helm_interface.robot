...
Deploying 3GPP PM Mapper
    ${override} =                       Set Variable                       --set global.centralizedLoggingEnabled=false --set drSubConfig.deliveryURL=http://dcae-pm-mapper:8081/delivery --set readiness.scheme=HTTP --set readiness.port=8081 --set applicationConfig.key_store_path=/opt/app/pm-mapper/etc/cert/cert.jks --set applicationConfig.key_store_pass_path=/opt/app/pm-mapper/etc/cert/jks.pass --set applicationConfig.trust_store_path=/opt/app/pm-mapper/etc/cert/trust.jks --set applicationConfig.trust_store_pass_path=/opt/app/pm-mapper/etc/cert/trust.pass --debug
