...
Usecase Teardown
    Disable Warnings
    Uninstall helm charts               e2e-dfcollector
    Uninstall helm charts               e2e-pmmapper
    Uninstall helm charts               e2e-sftp
...
Deploying Data File Collector
    Install helm charts                 chart-museum                       dcae-datafile-collector         e2e-dfcollector          3 min

Deploying 3GPP PM Mapper
    Install helm charts                 chart-museum                       dcae-datafile-collector         e2e-pmmapper             3 min

Deploying SFTP Server As xNF
    Install helm charts from folder     ${SFTP_HELM_CHARTS}                 dcae-datafile-collector        e2e-sftp                 3 min
