...
Setting Global Variables
    ...
    Set Global Variale   ${ONAP_HELM_RELEASE}   ${command_output[1]}
...
Deploying 3GPP PM Mapper
    Install helm charts                 chart-museum                       dcae-pm-mapper         ${ONAP_HELM_RELEASE}-pmmapper             3 min   --set drFeedConfig.feedVersion="0.0"

Deploying SFTP Server As xNF
    Install helm charts from folder     ${SFTP_HELM_CHARTS}                ${ONAP_HELM_RELEASE}-sftp                 2 min
