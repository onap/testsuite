...
Deploying 3GPP PM Mapper
    Install helm charts                 chart-museum                       dcae-datafile-collector         e2epmmapper             3 min

Deploying SFTP Server As xNF
    Install helm charts from folder     ${SFTP_HELM_CHARTS}                 dcae-datafile-collector        e2esftp                 3 min
