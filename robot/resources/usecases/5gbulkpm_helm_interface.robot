...
Deploying 3GPP PM Mapper
    Install helm charts                 chart-museum                       dcae-pm-mapper         e2epmmapper             3 min   --set drFeedConfig.feedVersion="0.0"

Deploying SFTP Server As xNF
    Install helm charts from folder     ${SFTP_HELM_CHARTS}                e2esftp                 2 min
