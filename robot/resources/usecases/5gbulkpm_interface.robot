...
Deploying 3GPP PM Mapper
    ...
    Deploy Service                      ${deployment_data}                 pmmapper                                            4 minutes
...
Deploying SFTP Server As xNF
    ...
    Deploy Service                      ${deployment_data}                 sftpserver                                            4 minutes
...
Deploying HTTPS server with correct certificates
    ...
    Deploy Service                      ${deployment_data}                 https-server-dep                    4 minutes
...
Deploying HTTPS server with wrong certificates - wrong SAN-s
    ...
    Deploy Service                      ${deployment_data}                 https-server-wrong-sans-dep                    4 minutes
...
Deploying VES Client with correct certificates
    ...
    Deploy Service                      ${deployment_data}                 ves-rest-client-dep                    4 minutes
...
Deploying VES collector with CMPv2 for bulkpm over https
    ...
    Deploy Service                      ${deployment_data}                 ves-collector-for-bulkpm-over-https                  4 minutes
