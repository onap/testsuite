...
Validate Json Event From Topic
    ...
    ${pm_even_resp_files} =  OperatingSystem.List Files In Directory  ${expected_result_path}
...
xNF PM File Validate
    ...
    Run Keyword If  '${expected_result_path}' != 'none'  Create File  ${expected_result_path}/pm_event-${timestamp}     ${json}
