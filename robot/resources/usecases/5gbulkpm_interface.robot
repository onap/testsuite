...
xNF PM File Validate
    [Arguments]     ${expected_result_path}
    Set Variable IF  '${expected_result_path}' != 'none'  Set Log Level  NONE
    ...
    ${json}=  To Json  ${resp.text}  pretty_print=True
    Run Keyword If  '${expected_result_path}' != 'none'  Append To File  ${expected_result_path}     ${json}
    Set Variable IF  '${expected_result_path}' != 'none'  Set Log Level  INFO
