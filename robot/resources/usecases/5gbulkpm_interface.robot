...
Deploying VES Client with correct certificates
    ...
    ${deployment_data}=                 Set Variable                       {"serviceTypeId": "${serviceTypeIdMongo}", "inputs": { "service_component_type": "mongo-5gbulkpm", "service_component_name_override": "mongo-5gbulkpm"}}
