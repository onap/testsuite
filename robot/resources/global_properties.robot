...
${GLOBAL_SO_SDCHAND_ENDPOINT}     ${GLOBAL_SO_SERVER_PROTOCOL}://${GLOBAL_INJECTED_SO_SDCHAND_IP_ADDR}:${GLOBAL_SO_SDCHAND_SERVER_PORT}
${GLOBAL_SO_BPMN_ENDPOINT}     ${GLOBAL_SO_SERVER_PROTOCOL}://${GLOBAL_INJECTED_SO_BPMN_IP_ADDR}:${GLOBAL_SO_BPMN_SERVER_PORT}
${GLOBAL_SO_CATDB_ENDPOINT}     ${GLOBAL_SO_SERVER_PROTOCOL}://${GLOBAL_INJECTED_SO_CATDB_IP_ADDR}:${GLOBAL_SO_CATDB_SERVER_PORT}
