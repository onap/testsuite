...
CDS Service Instantiate
    ...
    ${dcae_collector_ip}=  Set Variable  10.12.5.250
    ${dcae_collector_port}=  Set Variable  30417
    ${vlb_0_int_pktgen_private_port_0_mac}=  Set Variable  fa:16:3e:00:00:10
    ${vpg_0_int_pktgen_private_port_0_mac}=  Set Variable  fa:16:3e:00:00:20
    
    ${dict}=   Set To Dictionary  ${global_parameters}  dcae_collector_ip=${dcae_collector_ip}  dcae_collector_port=${dcae_collector_port}  vlb_0_int_pktgen_private_port_0_mac=${vlb_0_int_pktgen_private_port_0_mac}  vpg_0_int_pktgen_private_port_0_mac=${vpg_0_int_pktgen_private_port_0_mac}  service_instance_name=${cds_instance_name}  owning_entity=OE-Demonstration    homing_solution=none    owning_entity_id=${owning_entity_id}    subscriber_id=Demonstration  cloud_owner=${GLOBAL_AAI_CLOUD_OWNER}  subscription_service_type=vLB  service_model_name=${cds_service_model}  service_model_uuid=${service_uuid}  service_model_invariantuuid=${service_invariantUUID}  resp=${resp.json()}
