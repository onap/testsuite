...
Create Connectivity If Not Exists
    ...
    ${get_resp}=    Run AAI Get Request     ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_ROOT_PATH}/${connectivity-id}
...
Create Connectivity
    ...
    ${put_resp}=    Run AAI Put Request     ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_ROOT_PATH}/${connectivity-id}     ${data}
...
Delete Connectivity
    ...
    ${put_resp}=    Run AAI Delete Request    ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_ROOT_PATH}/${connectivity-id}    ${resource_version}
    Should Be Equal As Strings  ${put_resp.status_code}         204

Get Connectivity
    [Documentation]   Return Connectivity
    [Arguments]    ${connectivity-id}
    ${resp}=    Run AAI Get Request     ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_ROOT_PATH}/${connectivity-id}
...
Get Nodes Query Connectivity
    ...
    [Arguments]    ${connectivity-id}
    ${resp}=    Run AAI Get Request     ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_NODES_PATH}?connectivity-id=${connectivity-id}
    Should Be Equal As Strings  ${resp.status_code}     200
    [Return]  ${resp.json()}

Get Example Connectivity
    [Documentation]   Return Example Connectivity
    ${resp}=    Run AAI Get Request     ${AAI_CONN_API_IMPL_INDEX_PATH}${AAI_CONN_EXAMPLES_PATH}
    Should Be Equal As Strings  ${resp.status_code}     200
    [Return]  ${resp.json()}
...
Confirm API Not Implemented Connectivity
    ...
    [Arguments]    ${connectivity-id}
    ${resp}=    Run AAI Get Request     ${AAI_CONN_API_NA_INDEX_PATH}${AAI_CONN_ROOT_PATH}/${connectivity-id}
