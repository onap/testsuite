...
Create VNFC If Not Exists
    ...
    ${get_resp}=    Run A&AI Get Request     ${VNFC_INDEX_PATH}${VNFC_ROOT_PATH}/${vnfc_name}
...
Create VNFC
    ...
    ${put_resp}=    Run A&AI Put Request     ${VNFC_INDEX_PATH}${VNFC_ROOT_PATH}/${vnfc_name}    ${data}
...
Delete VNFC
    ...
    ${put_resp}=    Run A&AI Delete Request    ${VNFC_INDEX_PATH}${VNFC_ROOT_PATH}/${vnfc_name}    ${resource_version}
    Should Be Equal As Strings  ${put_resp.status_code}         204

Get VNFC
    [Documentation]    Return VNFC
    [Arguments]    ${vnfc_name}
    ${resp}=    Run A&AI Get Request     ${VNFC_INDEX_PATH}${VNFC_ROOT_PATH}/${vnfc_name}
