...
Install VES Client
    ${override} =                       Set Variable                       -f ${CMPv2_helm_values}/ves_client_values_cmpv2.yaml --set fullnameOverride=${ONAP_HELM_RELEASE}-ves-client-cmpv2 --set mongodb.fullnameOverride=${ONAP_HELM_RELEASE}-ves-client-cmpv2-db --set config.mongoDbName=${ONAP_HELM_RELEASE}-ves-client-cmpv2-db
--debug
