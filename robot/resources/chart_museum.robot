...
Add chart repository
    ...
    ${helm_repo_add}=                   Set Variable                        helm repo add ${chart_repo_name} ${chart_repo_fqdn} --password ${chart_repo_password} --user ${chart_repo_username}
...
Install helm charts
    ...
    [Arguments]                             ${chart_repo_name}                      ${dcae_servcie_helm_charts}         ${dcae_service_helm_name}     ${registry_ovveride}    ${wait_time}=2 min
