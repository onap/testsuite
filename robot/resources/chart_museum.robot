...
Checking Status Of Deployed Appliction Using Helm
    ...
    ${pod_status}=                      Set Variable                                kubectl get pods -n onap | grep ${dcae_service_helm_name}-${dcae_servcie_helm_charts} | awk '{print $2}'
    ...
    ${pod_ready}=                       Set Variable                                kubectl get pods -n onap | grep ${dcae_service_helm_name}-${dcae_servcie_helm_charts} | awk '{print $1}'
