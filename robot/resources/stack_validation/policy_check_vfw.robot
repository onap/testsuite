...
Policy Check Firewall Stack
    ...
    ${upper_bound}=    Evaluate    ${policy_rate}*2
    Wait Until Keyword Succeeds    30m    1s    Run VFW Policy Check    ${vpg_public_ip}   ${policy_rate}    ${upper_bound}    1
...
Check For Policy Enforcement
    ...
    Wait Until Keyword Succeeds    30s    5s    Test For Expected Rate    ${vpg_public_ip}    ${forced_rate}
    Wait Until Keyword Succeeds    600s    10s    Test For Expected Rate    ${vpg_public_ip}    ${policy_rate}
