...
Load CNF Customer
    ...
    Create Service If Not Exists    vFW_CNF_CDS

    ${arguments}=    Create Dictionary  subscriber_name=${customer_name}  global_customer_id=${customer_id}  subscriber_type=${customer_type}   cloud_owner1=${cloud_owner}  cloud_region_id1=${cloud_region_id}  tenant_id1=${tenant_id}  service1=vFW_CNF_CDS
