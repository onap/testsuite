...
${DCAEMOD_NIFI_REGISTRY_SERVER}               ${GLOBAL_DCAEMOD_NIFI_REGISTRY_PROTOCOL}://${GLOBAL_DCAEMOD_NIFI_REGISTRY_SERVER_NAME}:${GLOBAL_DCAEMOD_NIFI_REGISTRY_SERVER_PORT}
...
Is Component Onborded
    [Arguments]  ${compSpecName}
    ${session}=  Create Session  nifi-jars  ${DCAEMOD_NIFI_REGISTRY_SERVER}
    ${headers}=  Create Dictionary  content-type=application/json
    ${resp} =  Get Request    nifi-jars  /nifi-jars/  ${headers}
