...
Generate Random User Name
    ...
    ${App_LoginID}=     demoapp${RAND}
    ${App_Email_Address}=    demoapp${RAND}@onap.com
    ${Sta_LoginID}=    demosta${RAND}
    ${Sta_Email_Address}=    demosta${RAND}@onap.com
    ${Test_LoginID}=    portal${RAND}
    ${Test_Email_Address}=    portal${RAND}@onap.com
    ${AppUserName}=           testApp${RAND}
    ${AppPassword}=           testApp${RAND}123!
