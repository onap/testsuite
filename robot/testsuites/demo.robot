...
Instantiate VLB_CDS
    ...
    ${service-uuid}  ${service-invariantUUID}=  Get All Services Catalog  demoVLB_CDS
    ${resp}=   Get Service VNFs  demoVLB_CDS
    ${cds-request-id}=   Service Assign & Activate  demoVLB_CDS  ${service-uuid}  ${service-invariantUUID}  ${resp} 
    Check Infra Active Requests  ${cds-requestid}  
