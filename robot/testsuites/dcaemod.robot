...
Deploy DCAE Simple Application Without Config Map In Config Spec Json
    ...
    ${dict_values} =  Create Dictionary  comp_spec_name=Withoutcv
    ...
    ${processGroupId} =  Create Process Group  Sylwia123
    ...
    Save Flow By Version Controlling  Sylwia123  ${processGroupId}
    Distribute The Flow  ${processGroupId}
    Set Test Variable  ${is_flow_distributed_set}  True
    ${typeId}  ${blueprintName} =  Deploy Blueprint From Inventory  Sylwia123  ${compSpecName}
