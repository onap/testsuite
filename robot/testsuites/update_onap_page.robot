...
Update ONAP Page
    ...
    Set To Dictionary    ${values}   GLOBAL_INJECTED_UBUNTU_1404_IMAGE=${GLOBAL_INJECTED_UBUNTU_1404_IMAGE}
    Set To Dictionary    ${values}   GLOBAL_INJECTED_UBUNTU_1604_IMAGE=${GLOBAL_INJECTED_UBUNTU_1604_IMAGE}
