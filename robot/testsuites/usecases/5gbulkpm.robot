...
${DFC_BLUEPRINT_PATH}               /var/opt/ONAP/robot/assets/usecases/5gbulkpm//k8s-datafile.yaml
${PMMAPPER_BLUEPRINT_PATH}          /var/opt/ONAP/robot/assets/usecases/5gbulkpm//k8s-pm-mapper.yaml
...
${PMMAPPER_MR_CLUSTER_DATA}         /var/opt/ONAP/robot/assets/usecases/5gbulkpm/mr_clusters.json
